...
implements NavigationView.OnNavigationItemSelectedListener, DrawerLayout.DrawerListener, ServerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckNetwork network_ = new CheckNetwork(getApplicationContext());
            ...
            ASENDI.ID = getCredentials.getStringExtra("act");
            ASENDI.PSWD = getCredentials.getStringExtra("psd");
        ...
        private void refreshData() {
            try {
                Utils.connectToServer(HomeActivity.this, ASENDI.FEED, new String[] {
                    "user", "pswd"
                }, new String[] {
                    user, pswd
    ...
    private void setBadgeCount(int c) {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
            ...
            private void quitDevice() {
                ...
                alertDialogBuilder.setIcon(R.mipmap.asendi_logo);
            ...
            private void refreshFeed() {
                    ...
                    public void run() {
                        handler.post(() -> {
                            try {
                                if (Utils.isConnectionAvailable(getApplicationContext()) == false) {
                                    Utils.showNoConnectionAlert(getApplicationContext(), drawerLayout);
                                    ASENDI.ISCONNECTED = false;
                                } else {
                                    ASENDI.ISCONNECTED = true;
                                    Utils.connectToServer(HomeActivity.this, ASENDI.FEED, new String[] {
                                        "user", "pswd", "tkn"
                                    }, new String[] {
                ...
                ASENDI.TIMER.schedule(doAsynchronousTask,
                    0,
                    30000);
            }
