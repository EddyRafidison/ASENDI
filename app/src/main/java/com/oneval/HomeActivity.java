...
public class HomeActivity
  ...
  private void refreshData() {
    try {
      Utils.connectToServer(HomeActivity.this, ONEVAL.FEED, new String[] {"user", "pswd"},
  ...
  private void refreshFeed() {
        ...
        handler.post(() -> {
          try {
            if (Utils.isConnectionAvailable(getApplicationContext()) == false) {
              ...
              Utils.connectToServer(HomeActivity.this, ONEVAL.FEED,
    ...
    ONEVAL.TIMER.schedule(doAsynchronousTask, 0, 30000);
  }
}