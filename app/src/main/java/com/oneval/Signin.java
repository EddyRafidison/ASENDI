    ...
    if (Utils.isConnectionAvailable(getApplicationContext()) == false) {
      ...
      try {
        ...
        Utils.connectToServer(
            Signin.this, ONEVAL.CHECKAPP, new String[] {}, new String[] {}, true, response -> {
              try {
                      ...
                      try {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                          apkUri = FileProvider.getUriForFile(
                              Signin.this, "com.oneval.fileprovider", appfile);
        ...
        (arg0, arg1) -> {
          ...
          if (!sk.isEmpty()) {
            if (Utils.isConnectionAvailable(getApplicationContext()) == false) {
              ...
              arg0.dismiss();
              Utils.connectToServer(Signin.this, ONEVAL.REACC, new String[] {"user", "sk"},
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
      if (!getPackageManager().canRequestPackageInstalls()) {
        Intent inst = new Intent(Settings.ACTION_MANAGE_UNKNOWN_APP_SOURCES)
                          .setData(Uri.parse("package:com.oneval"));
        ...
        if (Utils.isConnectionAvailable(getApplicationContext()) == false) {
          ...
          if (status == 2) {
            ...
            if (Acc.isEmpty()) {
              ...
              Utils.connectToServer(Signin.this, ONEVAL.SIGNIN,
